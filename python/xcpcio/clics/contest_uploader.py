...
class ContestUploader:
    ...
    async def _fetch_contest_data(self) -> tuple[Dict[str, FileData], Dict[str, FileData], list[str], list[str], list[str]]:
        api_files = {}
        extra_files = {}
        changed_api_files = []
        changed_extra_files = []
    ...
    async def _fetch_endpoint_data(
        self, api_files: Dict[str, FileData], extra_files: Dict[str, FileData],
        changed_api_files: list[str], changed_extra_files: list[str], unchanged_files: list[str]
    ):
    ...
    async def fetch_and_upload(self) -> Optional[Dict]:
        ...
        api_files, extra_files, changed_api_files, changed_extra_files, unchanged_files = await self._fetch_contest_data()
